...
impl NameDivider for TwoCharNameDivider {
    fn divide_name(&self, undivided_name: &String) -> DividedName {
        self.name_divider_base.divide_name(undivided_name, &self.two_char_score_calculator)
    }
}

pub fn get_two_char_name_divider(separator: String, normalize_name: bool, algorithm_name: String) -> TwoCharNameDivider{
    ...
    TwoCharNameDivider{ two_char_score_calculator, name_divider_base }
}